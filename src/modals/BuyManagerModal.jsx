    ...
    >
      ...
      >
        ...
        <h2 style={styles.title}>
          Você pode escolher quantos <b>Gestor</b> quer comprar,
          <br/>Digite o número de vendedores (gestores):
        </h2>
        ...
        <input
          ...
          inputMode="numeric"
          min={1}
          placeholder="Digite o número de Gestor"
          value={qty}
        ...
        <div style={styles.infoBox}>
          ...
          <div style={{opacity:.9, marginBottom:8}}>
            Base para cálculo despesa: <b>x quantidade de gestor comercial</b>.<br/>
          ...
          <div style={styles.table}>
            ...
            <Row label="Sem Certificado"  hire={5000} expense={3000} revenue="potencializar colaboradores em 20%"/>
            <Row label="Com 1 certificado" hire="-" expense={3500} revenue="potencializar colaboradores em 30%"/>
            <Row label="Com 2 certificados" hire="-" expense={4000} revenue="potencializar colaboradores em 40%"/>
            <Row label="Com 3 certificados" hire="-" expense={4500} revenue="potencializar colaboradores em 60%"/>
          </div>
        </div>
